...
public class WordGenerator : MonoBehaviour
{
    ...
    private static string[] wordList = {   "sidewalk", "robin", "three", "protect", "periodic",
                                    ...
                                    "ablaze", "thoughtless", "love", "verdict", "giant", "table", "chair", "vehicle",
                                    "consumer", "tool", "praise", "block", "compound", "exotic", "panic", "railroad",
                                    "diplomat", "borrow", "pass", "cold", "smoke", "nut", "grow", "directory"};
